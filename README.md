...
Developed a Secure Message Encryption System using Python, Streamlit, and Fernet AES cryptography to enable secure encrypted communication and QR-based message sharing. Implemented password-protected decryption, QR scanning/upload functionality, secure key management, and real-time encryption workflows while applying core cybersecurity, privacy, and secure data transmission principles.
